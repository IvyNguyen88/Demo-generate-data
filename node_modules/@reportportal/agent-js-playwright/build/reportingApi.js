...
exports.ReportingApi = {
    ...
    log: (level = constants_1.LOG_LEVELS.INFO, message = '', file, suite) => (0, utils_1.sendEventToReporter)(events_1.EVENTS.ADD_LOG, { level, message, file }, suite),
    launchLog: (level = constants_1.LOG_LEVELS.INFO, message = '', file) => (0, utils_1.sendEventToReporter)(events_1.EVENTS.ADD_LAUNCH_LOG, { level, message, file }),
